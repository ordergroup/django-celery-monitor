...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RunSQL(
            ...
            """,
            reverse_sql="""
                DROP MATERIALIZED VIEW IF EXISTS celery_status_counts;
            """,
        ),
        ...
        migrations.RunSQL(
            ...
            """,
            reverse_sql="""
                DROP FUNCTION IF EXISTS refresh_celery_status_counts();
            """,
        ),
        # Create trigger to auto-refresh on INSERT/UPDATE/DELETE
        migrations.RunSQL(
            sql="""
                CREATE TRIGGER refresh_celery_status_counts_trigger
                AFTER INSERT OR UPDATE OR DELETE ON django_celery_results_taskresult
